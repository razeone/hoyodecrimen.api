...
class FlaskTestCase(unittest.TestCase):
    ...
    def test_api_v1_top_counts_change_cuadrantes(self):
        ...
        response = tester.get('/api/v1/cuadrantes/crimes/' +
                              'homicidio%20doloso/top/counts/change',
                              content_type='application/json')
        empty_data = {"rows": ""}
        self.assertEqual(response.status_code, 200)
        self.assertNotEqual(response.data, empty_data)
    ...
    def test_error_api_v1_top_counts_change_cuadrantes_dates(self):
        ...
        response = tester.get(base_url +
                              ...
                              '2013-12&start_period2=2014-01&' +
                              'end_period2=2014-06',
                              content_type='application/json')
        self.assertEqual(response.status_code, 200)
        # Invalid dates or dates before 2013-01
        response = tester.get(base_url +
                              '?start_period1=2005-19',
                              content_type='application/json')
        self.assertEqual(response.status_code, 400)

        response = tester.get(base_url +
                              '?start_period2=2005-19',
                              content_type='application/json')
        self.assertEqual(response.status_code, 400)
        response = tester.get(base_url +
                              '?end_period1=2005-19',
        ...
        self.assertEqual(response.status_code, 400)
        response = tester.get(base_url +
                              '?start_period1=2012-12',
                              content_type='application/json')
        self.assertEqual(response.status_code, 400)
        # test with all dates specified
        response = tester.get(base_url +
                              '?start_period1=2005-19&end_period1=' +
                              '2005-19&start_period2=' +
                              '2005-19&end_period2=2005-19',
                              content_type='application/json')
        self.assertEqual(response.status_code, 400)
        # Overlapping periods
        response = tester.get(base_url +
                              '?start_period1=2013-01&end_period1=' +
                              '2013-06&start_period2=2013-03' +
                              '&end_period2=2014-02',
                              content_type='application/json')
        # 1sr period invalid
        response = tester.get(base_url + '?start_period1=2013-06&' +
                              'end_period1=2013-01&start_period2=' +
                              '2013-03&end_period2=2014-02',
                              content_type='application/json')
        self.assertEqual(response.status_code, 400)
    ...
    def test_top_rates_sectores(self):
        ...
        tester = app.test_client(self)
        response = tester.get(base_url + '?start_date=2013-08&' +
                              'end_date=2014-07',
                              content_type='application/json')
        self.assertEqual(response.status_code, 200)
        # End date is smaller than start date
        response = tester.get(base_url + '?start_date=2014-08&' +
                              'end_date=2013-07',
                              content_type='application/json')
        self.assertEqual(response.status_code, 400)
        # Start date is smaller than 2013 (when the data was collected)
        response = tester.get(base_url + '?start_date=2012-08&' +
                              'end_date=2013-07',
                              content_type='application/json')
        self.assertEqual(response.status_code, 400)
        # Equal dates are allowed since it would only span that month
        response = tester.get(base_url + '?start_date=2014-07' +
                              '&end_date=2014-07',
                              content_type='application/json')
        self.assertEqual(response.status_code, 200)
    ...
    def test_api_v1_enumerate_sectores(self):
        tester = app.test_client(self)
        response = tester.get('/api/v1/sectores',
                              content_type='application/json')
        self.assertEqual(response.status_code, 200)
        self.assertNotEqual(response.data, {"rows": []})
    ...
    def test_api_v1_enumerate_cuadrantes(self):
        tester = app.test_client(self)
        response = tester.get('/api/v1/cuadrantes',
                              content_type='application/json')
        self.assertEqual(response.status_code, 200)
        self.assertNotEqual(response.data, {"rows": []})
    ...
    def test_api_v1_list_change_cuadrantes_all(self):
        ...
        tester = app.test_client(self)
        response = tester.get(base_url + '?start_period1=2013-01&' +
                              'end_period1=2013-12&start_period2=' +
                              '2014-01&end_period2=2014-06',
                              content_type='application/json')
        self.assertEqual(response.status_code, 200)
        self.assertNotEqual(response.data, {"rows": []})
        # Invalid dates or dates before 2013-01
        response = tester.get(base_url + '?start_period1=2005-19',
                              content_type='application/json')
        self.assertEqual(response.status_code, 400)
        response = tester.get(base_url + '?start_period2=2005-19',
                              content_type='application/json')
        self.assertEqual(response.status_code, 400)
        response = tester.get(base_url + '?end_period1=2005-19',
                              content_type='application/json')
        self.assertEqual(response.status_code, 400)
        response = tester.get(base_url + '?end_period2=2005-19',
                              content_type='application/json')
        self.assertEqual(response.status_code, 400)
        response = tester.get(base_url + '?start_period1=2005-19',
                              content_type='application/json')
        self.assertEqual(response.status_code, 400)
        response = tester.get(base_url + '?start_period1=2012-12',
                              content_type='application/json')
        self.assertEqual(response.status_code, 400)
        # test with all dates specified
        response = tester.get(base_url + '?start_period1=2005-19&' +
                              'end_period1=2005-19&start_period2=' +
                              '2005-19&end_period2=2005-19',
                              content_type='application/json')
        self.assertEqual(response.status_code, 400)
        # Overlapping periods
        response = tester.get(base_url + '?start_period1=2013-01&' +
                              'end_period1=2013-06&start_period2=' +
                              '2013-03&end_period2=2014-02',
                              content_type='application/json')
        # 1sr period invalid
        response = tester.get(base_url + '?start_period1=2013-06&' +
    ...
    def test_api_v1_list_sectores_all(self):
        ...
        self.assertNotEqual(response.data, {"rows": []})
        # Success
        response = tester.get(base_url + '?start_date=2014-01&' +
                              'end_date=2014-07',
                              content_type='application/json')
        self.assertEqual(response.status_code, 200)
        self.assertNotEqual(response.data, {"rows": []})
    ...
    def test_api_v1_pip(self):
        tester = app.test_client(self)
        response = tester.get('/api/v1/cuadrantes/pip/' +
                              '-99.13333/19.43',
                              content_type='application/json')
        self.assertEqual(response.status_code, 200)
        self.assertNotEqual(response.data, {"rows": []})
    ...
    def test_api_v1_pip(self):
        ...
        response = tester.get('/api/v1/latlong/crimes/' +
                              ...
                              'ROBO%20A%20TRANSEUNTE%20S.V.,' +
                              'ROBO%20A%20BORDO%20DE%20TAXI%20C.V.,' +
                              'ROBO%20A%20BORDO%20DE%20MICROBUS%20S.V.,' +
                              'ROBO%20A%20BORDO%20DE%20MICROBUS%20C.V.,' +
                              'ROBO%20A%20BORDO%20DE%20METRO%20S.V.,' +
                              'ROBO%20A%20BORDO%20DE%20METRO%20C.V.' +
                              '/coords/-99.122815/19.506460/distance/' +
                              '50000000000?start_date=2016-01&' +
                              'end_date=2016-04',
                              content_type='application/json')
        self.assertEqual(response.status_code, 200)
        self.assertNotEqual(response.data, {"rows": []})
    ...
    def test_api_v1_pip(self):
        ...
        response = tester.get('/api/v1/cuadrantes/crimes/HOMICIDIO%20DOLOSO,' +
                              ...
                              'ROBO%20DE%20VEHICULO%20AUTOMOTOR%20S.V.,' +
                              'ROBO%20DE%20VEHICULO%20AUTOMOTOR%20C.V.,' +
                              'ROBO%20A%20TRANSEUNTE%20C.V.' +
                              '/pip_extra/-99.133208/19.432605540309215',
                              content_type='application/json')
        self.assertEqual(response.status_code, 200)
        self.assertNotEqual(response.data, {"rows": []})
    ...
    def test_api_404(self):
        tester = app.test_client(self)
        response = tester.get('/ddwoijeidjjaskljfklds' +
                              'jfkjasklfjklsafsadfs', content_type='html/text')
    ...
    def test_api_v1_mun_series(self):
        tester = app.test_client(self)
        response = tester.get('/api/v1/municipios/tlalpan/' +
                              'crimes/homicidio%20doloso/series',
                              content_type='application/json')
        self.assertEqual(response.status_code, 200)
        self.assertNotEqual(response.data, {"rows": []})
